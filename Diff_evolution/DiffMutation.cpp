...
IndividualDiffEvolution DiffMutation::getDonor(IndividualDiffEvolution *arrIndividuals, IndividualDiffEvolution &best,
                                               int ammInd)
{
    ...
    {
        donor =
            (arrIndividuals[selectedInd[0]] + ((arrIndividuals[selectedInd[1]] - arrIndividuals[selectedInd[2]]) * F));
    }
